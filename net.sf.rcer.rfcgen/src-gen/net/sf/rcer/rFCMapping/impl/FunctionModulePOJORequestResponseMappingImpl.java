 ...
 * <ul>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJORequestResponseMappingImpl#getRequestClassName <em>Request Class Name</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJORequestResponseMappingImpl#getRequestParameters <em>Request Parameters</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJORequestResponseMappingImpl#getResponseClassName <em>Response Class Name</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJORequestResponseMappingImpl#getResponseParameters <em>Response Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionModulePOJORequestResponseMappingImpl extends FunctionModulePOJOMappingImpl implements FunctionModulePOJORequestResponseMapping
{
  ...
  {
    return RFCMappingPackage.Literals.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING;
  }
  ...
  public void setRequestClassName(String newRequestClassName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__REQUEST_CLASS_NAME, oldRequestClassName, requestClassName));
  }
  ...
  public EList<FunctionModulePOJOParameterMapping> getRequestParameters()
  {
    ...
    {
      requestParameters = new EObjectContainmentEList<FunctionModulePOJOParameterMapping>(FunctionModulePOJOParameterMapping.class, this, RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__REQUEST_PARAMETERS);
    }
  ...
  public void setResponseClassName(String newResponseClassName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__RESPONSE_CLASS_NAME, oldResponseClassName, responseClassName));
  }
  ...
  public EList<FunctionModulePOJOParameterMapping> getResponseParameters()
  {
    ...
    {
      responseParameters = new EObjectContainmentEList<FunctionModulePOJOParameterMapping>(FunctionModulePOJOParameterMapping.class, this, RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__RESPONSE_PARAMETERS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__REQUEST_PARAMETERS:
        return ((InternalEList<?>)getRequestParameters()).basicRemove(otherEnd, msgs);
      case RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__RESPONSE_PARAMETERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__REQUEST_CLASS_NAME:
        return getRequestClassName();
      case RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__REQUEST_PARAMETERS:
        return getRequestParameters();
      case RFCMappingPackage.FUNCTION_MODULE_POJO_REQUEST_RESPONSE_MAPPING__RESPONSE_CLASS_NAME:
