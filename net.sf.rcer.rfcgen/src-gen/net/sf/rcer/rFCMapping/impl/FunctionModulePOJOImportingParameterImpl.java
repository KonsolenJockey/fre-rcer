 ...
 * <ul>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJOImportingParameterImpl#isIsStructure <em>Is Structure</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.FunctionModulePOJOImportingParameterImpl#isIsTable <em>Is Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionModulePOJOImportingParameterImpl extends FunctionModulePOJOParameterMappingImpl implements FunctionModulePOJOImportingParameter
{
  ...
  {
    return RFCMappingPackage.Literals.FUNCTION_MODULE_POJO_IMPORTING_PARAMETER;
  }
  ...
  public void setIsStructure(boolean newIsStructure)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RFCMappingPackage.FUNCTION_MODULE_POJO_IMPORTING_PARAMETER__IS_STRUCTURE, oldIsStructure, isStructure));
  }
  ...
  public void setIsTable(boolean newIsTable)
  {
    ...
    isTable = newIsTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RFCMappingPackage.FUNCTION_MODULE_POJO_IMPORTING_PARAMETER__IS_TABLE, oldIsTable, isTable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RFCMappingPackage.FUNCTION_MODULE_POJO_IMPORTING_PARAMETER__IS_STRUCTURE:
        return isIsStructure();
      case RFCMappingPackage.FUNCTION_MODULE_POJO_IMPORTING_PARAMETER__IS_TABLE:
        return isIsTable();
    }
