 ...
 * <ul>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.ModelImpl#getPackageName <em>Package Name</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.ModelImpl#getStructures <em>Structures</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.impl.ModelImpl#getFunctionModules <em>Function Modules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return RFCMappingPackage.Literals.MODEL;
  }
  ...
  public void setPackageName(String newPackageName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RFCMappingPackage.MODEL__PACKAGE_NAME, oldPackageName, packageName));
  }
  ...
  public EList<Structure> getStructures()
  {
    if (structures == null)
    {
      structures = new EObjectContainmentEList<Structure>(Structure.class, this, RFCMappingPackage.MODEL__STRUCTURES);
    }
    return structures;
  }
  ...
  public EList<FunctionModule> getFunctionModules()
  {
    ...
    {
      functionModules = new EObjectContainmentEList<FunctionModule>(FunctionModule.class, this, RFCMappingPackage.MODEL__FUNCTION_MODULES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RFCMappingPackage.MODEL__STRUCTURES:
        return ((InternalEList<?>)getStructures()).basicRemove(otherEnd, msgs);
      case RFCMappingPackage.MODEL__FUNCTION_MODULES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RFCMappingPackage.MODEL__PACKAGE_NAME:
