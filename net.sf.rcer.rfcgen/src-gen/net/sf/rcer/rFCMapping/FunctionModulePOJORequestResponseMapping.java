 ...
 * <ul>
 *   <li>{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getRequestClassName <em>Request Class Name</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getRequestParameters <em>Request Parameters</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getResponseClassName <em>Response Class Name</em>}</li>
 *   <li>{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getResponseParameters <em>Response Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.sf.rcer.rFCMapping.RFCMappingPackage#getFunctionModulePOJORequestResponseMapping()
 * @model
 * @generated
 */
public interface FunctionModulePOJORequestResponseMapping extends FunctionModulePOJOMapping
{
   ...
   * @see net.sf.rcer.rFCMapping.RFCMappingPackage#getFunctionModulePOJORequestResponseMapping_RequestClassName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getRequestClassName <em>Request Class Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.rcer.rFCMapping.RFCMappingPackage#getFunctionModulePOJORequestResponseMapping_RequestParameters()
   ...
   * @see net.sf.rcer.rFCMapping.RFCMappingPackage#getFunctionModulePOJORequestResponseMapping_ResponseClassName()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.sf.rcer.rFCMapping.FunctionModulePOJORequestResponseMapping#getResponseClassName <em>Response Class Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see net.sf.rcer.rFCMapping.RFCMappingPackage#getFunctionModulePOJORequestResponseMapping_ResponseParameters()
   * @model containment="true"
   * @generated
   */
