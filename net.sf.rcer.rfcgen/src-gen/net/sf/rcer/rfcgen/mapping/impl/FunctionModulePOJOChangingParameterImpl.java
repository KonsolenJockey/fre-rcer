 ...
 * <ul>
 *   <li>{@link net.sf.rcer.rfcgen.mapping.impl.FunctionModulePOJOChangingParameterImpl#isIsStructure <em>Is Structure</em>}</li>
 *   <li>{@link net.sf.rcer.rfcgen.mapping.impl.FunctionModulePOJOChangingParameterImpl#isIsTable <em>Is Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionModulePOJOChangingParameterImpl extends FunctionModulePOJOParameterMappingImpl implements FunctionModulePOJOChangingParameter
{
  ...
  public void setIsStructure(boolean newIsStructure)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.FUNCTION_MODULE_POJO_CHANGING_PARAMETER__IS_STRUCTURE, oldIsStructure, isStructure));
  }
  ...
  public void setIsTable(boolean newIsTable)
  {
    ...
    isTable = newIsTable;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MappingPackage.FUNCTION_MODULE_POJO_CHANGING_PARAMETER__IS_TABLE, oldIsTable, isTable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MappingPackage.FUNCTION_MODULE_POJO_CHANGING_PARAMETER__IS_STRUCTURE:
        return isIsStructure();
      case MappingPackage.FUNCTION_MODULE_POJO_CHANGING_PARAMETER__IS_TABLE:
        return isIsTable();
    }
