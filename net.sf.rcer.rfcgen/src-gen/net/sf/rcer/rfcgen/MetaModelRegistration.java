...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://www.sf.net/rcer/rfcgen";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
				InputStream in = MetaModelRegistration.class.getResourceAsStream("rfcgen.ecore");
				Resource r = TypeResolver.getResourceSet().createResource(URI.createURI("net/sf/rcer/rfcgen/rfcgen.ecore"));
				try {
					r.load(in, null);
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://www.sf.net/rcer/rfcgen");
	}
		...
		if (xtextfile == null) {
			...
			try {
				...
				final URL url = ResourceLoaderFactory.createResourceLoader()
						.getResource("net/sf/rcer/rfcgen/rfcgen.xmi");
				...
				System.out.println("Couldn't load xmi file (net/sf/rcer/rfcgen/rfcgen.xmi)");
			} finally {
				ResourceLoaderFactory
