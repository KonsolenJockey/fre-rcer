...
({ptm.createNode(((EObject)((EObject)((EObject)xtextfile.eContents().get(5)).eContents().get(1)).eContents().get(4)));}temp_FunctionModuleMapping=
...
({ptm.createNode(((EObject)((EObject)((EObject)xtextfile.eContents().get(8)).eContents().get(1)).eContents().get(3)));}temp_FunctionModulePOJOParameterMapping=
...
({ptm.createNode(((EObject)((EObject)((EObject)xtextfile.eContents().get(9)).eContents().get(1)).eContents().get(4)));}temp_FunctionModulePOJOParameterMapping=
ruleFunctionModulePOJOParameterMapping{if (temp_FunctionModulePOJOParameterMapping != null) {
  hasContent = true;
  ptm.setModelElement(temp_FunctionModulePOJOParameterMapping);
...
({ptm.createNode(((EObject)((EObject)((EObject)xtextfile.eContents().get(9)).eContents().get(1)).eContents().get(10)));}temp_FunctionModulePOJOParameterMapping=
ruleFunctionModulePOJOParameterMapping{if (temp_FunctionModulePOJOParameterMapping != null) {
  hasContent = true;
  ptm.setModelElement(temp_FunctionModulePOJOParameterMapping);
