 ...
 * <blockquote><pre>
 * ChangeOrderOwnerCall call = new ChangeOrderOwnerCall();
 * call.setFoo(...);
 * call.execute(destination);
 * bar = call.getBar();
 * </pre></blockquote>
 */
public class ChangeOrderOwnerCall {
	 ...
	 */
	public ChangeOrderOwnerCall() {
		_pcs = new PropertyChangeSupport(this);
	}

	/**
	 * @return the ID of the transport order (IV_TRKORR)
	 */
	...
	/**
	 * Changes the ID of the transport order (IV_TRKORR).
	...
	/**
	 * @return the user name of the new owner (IV_NEW_OWNER)
	 */
	...
	/**
	 * Changes the user name of the new owner (IV_NEW_OWNER).
