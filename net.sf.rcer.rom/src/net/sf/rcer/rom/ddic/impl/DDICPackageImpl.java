...
public class DDICPackageImpl extends EPackageImpl implements DDICPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link DDICPackage#eINSTANCE} when that field is accessed.
	...
	public static DDICPackage init() {
		...
		DDICPackageImpl theDDICPackage = (DDICPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DDICPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DDICPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(DDICPackage.eNS_URI, theDDICPackage);
