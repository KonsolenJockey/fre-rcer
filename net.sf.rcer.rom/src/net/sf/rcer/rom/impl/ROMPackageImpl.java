...
public class ROMPackageImpl extends EPackageImpl implements ROMPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link ROMPackage#eINSTANCE} when that field is accessed.
	...
	public static ROMPackage init() {
		...
		ROMPackageImpl theROMPackage = (ROMPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ROMPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ROMPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ROMPackage.eNS_URI, theROMPackage);
