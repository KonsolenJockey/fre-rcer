...
public class ABAPObjectsPackageImpl extends EPackageImpl implements ABAPObjectsPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link ABAPObjectsPackage#eINSTANCE} when that field is accessed.
	...
	public static ABAPObjectsPackage init() {
		...
		ABAPObjectsPackageImpl theABAPObjectsPackage = (ABAPObjectsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ABAPObjectsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ABAPObjectsPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(ABAPObjectsPackage.eNS_URI, theABAPObjectsPackage);
