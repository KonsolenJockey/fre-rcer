...
public class RFCMappingActivator extends AbstractUIPlugin {
	...
	public static final String NET_SF_RCER_RFCGEN_RFCMAPPING = "net.sf.rcer.rfcgen.RFCMapping";
	
	private static final Logger logger = Logger.getLogger(RFCMappingActivator.class);
	...
	protected Module getRuntimeModule(String grammar) {
		if (NET_SF_RCER_RFCGEN_RFCMAPPING.equals(grammar)) {
