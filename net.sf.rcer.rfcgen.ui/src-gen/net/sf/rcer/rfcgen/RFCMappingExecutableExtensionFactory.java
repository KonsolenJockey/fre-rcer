...
public class RFCMappingExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		net.sf.rcer.rfcgen.internal.RFCMappingActivator instance = net.sf.rcer.rfcgen.internal.RFCMappingActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = net.sf.rcer.rfcgen.internal.RFCMappingActivator.getInstance().getInjector("net.sf.rcer.rfcgen.RFCMapping");
